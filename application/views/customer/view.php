...
//  $_mrcnt_pos_api_token     = $_record[0]['mrcnt_pos_api_token'];
    ...
    $_xero_lineAmount         = $_record[0]['mrcnt_xero_lineAmount'];
    ...
    <div class="panel-body">
        ...
        <form class="form-horizontal" role="form">
            ...
            <div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="" class="col-lg-4 col-sm-4 control-label">Server</label>
						<div class="col-lg-8">
							<p class="form-control-static"><?php echo $_record[0]['partner_country'];?></p>
						</div>
					</div>
				</div>
            </div>
    ...
    <div class="col-lg-6">
        ...
        <hr>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="" class="col-lg-4 col-sm-4 control-label">XERO API KEY</label>
                                <div class="col-lg-8">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="" class="col-lg-4 col-sm-4 control-label">XERO API SECRET</label>
                                <div class="col-lg-8">
						...
						<div class="col-md-12">
							<div class="form-group">
								<label for="" class="col-lg-4 col-sm-4 control-label">XERO LineAmount Types</label>
								<div class="col-lg-8">
									<p class="form-control-static">: <?php echo $_xero_lineAmount;?></p>
								</div>
							</div>
						</div>
                    </div>
